...
Notation[ParsedBoxWrapper[TagBox[SubscriptBox[OverscriptBox["a_", "^"], "b_"], "NotationTemplateTag"]] \[DoubleLongLeftRightArrow] ParsedBoxWrapper[RowBox[{"Operator", "[", RowBox[{"a_", ",", "b_"}], "]"}]]]
Notation[\!\(\*
TagBox[
OverscriptBox["a_", "^"],
...
Editable->True]\)]
Notation[ParsedBoxWrapper[TemplateBox[{"a_"}, "Ket"]]\[DoubleLongLeftRightArrow] \!\(\*
TagBox[
RowBox[{"Operator", "[", 
RowBox[{"ket", ",", "a_"}], "]"}],
"NotationTemplateTag",
BaseStyle->"NotationTemplateStyle",
Editable->True]\)]
Notation[ParsedBoxWrapper[TemplateBox[{"a_"}, "Bra"]]\[DoubleLongLeftRightArrow] \!\(\*
TagBox[
RowBox[{"Operator", "[", 
RowBox[{"bra", ",", "a_"}], "]"}],
"NotationTemplateTag",
